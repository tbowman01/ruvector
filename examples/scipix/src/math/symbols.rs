...
pub static SYMBOL_MAP: Lazy<HashMap<char, MathSymbol>> = Lazy::new(|| {
    ...
    map.insert('α', MathSymbol {
        unicode: 'α',
        latex: "alpha".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('β', MathSymbol {
        unicode: 'β',
        latex: "beta".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('γ', MathSymbol {
        unicode: 'γ',
        latex: "gamma".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('δ', MathSymbol {
        unicode: 'δ',
        latex: "delta".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('ε', MathSymbol {
        unicode: 'ε',
        latex: "epsilon".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["varepsilon".to_string()],
    });
    map.insert('ζ', MathSymbol {
        unicode: 'ζ',
        latex: "zeta".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('η', MathSymbol {
        unicode: 'η',
        latex: "eta".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('θ', MathSymbol {
        unicode: 'θ',
        latex: "theta".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["vartheta".to_string()],
    });
    map.insert('ι', MathSymbol {
        unicode: 'ι',
        latex: "iota".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('κ', MathSymbol {
        unicode: 'κ',
        latex: "kappa".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('λ', MathSymbol {
        unicode: 'λ',
        latex: "lambda".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('μ', MathSymbol {
        unicode: 'μ',
        latex: "mu".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('ν', MathSymbol {
        unicode: 'ν',
        latex: "nu".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('ξ', MathSymbol {
        unicode: 'ξ',
        latex: "xi".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('π', MathSymbol {
        unicode: 'π',
        latex: "pi".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["varpi".to_string()],
    });
    map.insert('ρ', MathSymbol {
        unicode: 'ρ',
        latex: "rho".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["varrho".to_string()],
    });
    map.insert('σ', MathSymbol {
        unicode: 'σ',
        latex: "sigma".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["varsigma".to_string()],
    });
    map.insert('τ', MathSymbol {
        unicode: 'τ',
        latex: "tau".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('υ', MathSymbol {
        unicode: 'υ',
        latex: "upsilon".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('φ', MathSymbol {
        unicode: 'φ',
        latex: "phi".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec!["varphi".to_string()],
    });
    map.insert('χ', MathSymbol {
        unicode: 'χ',
        latex: "chi".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('ψ', MathSymbol {
        unicode: 'ψ',
        latex: "psi".to_string(),
        category: SymbolCategory::Greek,
        alternatives: vec![],
    });
    map.insert('ω', MathSymbol {
        unicode: 'ω',
    ...
    map.insert('ℕ', MathSymbol {
        unicode: 'ℕ',
        latex: "mathbb{N}".to_string(),
        category: SymbolCategory::SetTheory,
        alternatives: vec![],
    });
    map.insert('ℤ', MathSymbol {
        unicode: 'ℤ',
        latex: "mathbb{Z}".to_string(),
        category: SymbolCategory::SetTheory,
        alternatives: vec![],
    });
    map.insert('ℚ', MathSymbol {
        unicode: 'ℚ',
        latex: "mathbb{Q}".to_string(),
        category: SymbolCategory::SetTheory,
        alternatives: vec![],
    });
    map.insert('ℝ', MathSymbol {
        unicode: 'ℝ',
        latex: "mathbb{R}".to_string(),
        category: SymbolCategory::SetTheory,
        alternatives: vec![],
    });
    map.insert('ℂ', MathSymbol {
        unicode: 'ℂ',
    ...
    map.insert('ℓ', MathSymbol {
        unicode: 'ℓ',
        latex: "ell".to_string(),
        category: SymbolCategory::Misc,
        alternatives: vec![],
    });
    map.insert('ℏ', MathSymbol {
        unicode: 'ℏ',
    ...
    map.insert('ℜ', MathSymbol {
        unicode: 'ℜ',
        latex: "Re".to_string(),
        category: SymbolCategory::Misc,
        alternatives: vec![],
    });
    map.insert('ℑ', MathSymbol {
        unicode: 'ℑ',
        latex: "Im".to_string(),
        category: SymbolCategory::Misc,
        alternatives: vec![],
